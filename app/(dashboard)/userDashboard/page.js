...
function AnimatedGlobe() {
  return (
    <div className="relative w-32 h-32 mx-auto mb-8">
      ...
      <Leaf className="absolute inse
      t-0 m-auto h-16 w-16 text-green-600 animate-pulse" />
    </div>
  );
}
...
export default function Home() {
  ...
  return (
    <div className={`container mx-auto px-4 py-16 [background:var(--background-start)] ${poppins.className}`}>
      <section className="text-center mb-20 [background:var(--background-start)] ">
        <AnimatedGlobe />
        <h1 className="text-6xl font-bold mb-6 [color:var(--text-color-primary)] tracking-tight">
          EcoSnap <span className="text-green-600">Waste Management</span>
        </h1>
        <p className="text-xl [color:var(--text-color-primary)] max-w-2xl mx-auto leading-relaxed mb-8">
