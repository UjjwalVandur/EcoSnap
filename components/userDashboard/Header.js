...
export default function Header({ onMenuClick, totalEarnings }) {
  ...
  return (
    <>
      <header className="[background:var(--background-start)] border-b border-gray-200 sticky top-0 z-50">
        <div className="flex items-center justify-between px-4 py-2">
          <div className="flex items-center">
            ...
            <Link href="/" className="flex items-center">
              ...
              <div className="flex flex-col">
                <span className="font-bold text-base md:text-lg [color:var(--text-color-primary)]">
                  EcoSnap
                </span>
                <span className="text-[8px] md:text-[10px] [color:var(--text-color-primary)] -mt-1">
                  ETHOnline24
                </span>
              </div>
            </Link>
          ...
          <div className="flex items-center">
            <button onClick={toggleTheme} className="swap swap-rotate px-2">
            ...
            <div className="mr-2 md:mr-4 flex items-center [background:var(--secondary-background)] rounded-full px-2 md:px-3 py-1">
              <Coins className="h-4 w-4 md:h-5 md:w-5 mr-1 text-green-500" />
              <span className="font-semibold text-sm md:text-base [color:var(--text-color)]">
                {balance.toFixed(2)}
              </span>
            </div>
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="[background:var(--secondary-background)] [color:var(--text-color)]">
